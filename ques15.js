...
var myFriends = ["Hooriya", "Anjum", "Zainab", "Wania"];
console.log("Due to some personal reasons, Ms. ".concat(myFriends[1], " will not be able to come to my dinner."));
myFriends[1] = "Aina";
...
// console.log(`Due to some personal reasons, Ms.${myFriends[1]} will not come at my dinner.`);
// myFriends[1] = "Aina";
